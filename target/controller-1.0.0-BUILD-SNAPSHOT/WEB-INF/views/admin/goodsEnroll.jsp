...
<body>
			...
			<form action="/admin/goodsEnroll" method="post" id="enrollForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						...
						<span class="ck_warn bookDiscount_warn">상품 할인율을 입력해주세요.</span> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="bookIntro"> <span
							class="ck_warn bookIntro_warn">책 소개를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
					...
					<div class="form_section_content">
						<input name="bookContents"> <span
							class="ck_warn bookContents_warn">책 목차를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
	...
	<script>
		...
		$(cateSelect1).on("change", function(){
			...
			//그런데 지금 현재의 코드에 문제가 하나 있습니다. 대분류, 중분류, 소분류 순으로 선택을 한 뒤 다시 
			//대분류를 선택을 하게 되면 중분류는 정상적으로 기존의 코드가 없어지고 기본 <option> 태그가 출력이되는데 
			//소분류는 기존의 <option> 태그가 그대로 있습니다. 
			//이는 중분류 선택이 변경되었을 때만 소분류가 초기화되도록 작성하였기 때문입니다. 이를 해결하기 위해선 대분류가 변경되었을 때도 
			//소분류가 초기화 되도록 코드를 추가해주어야 합니다. 중분류 <option> 태그를 출력하는 메서드(대분류가 변경되었을 때 동작)에 아래의 코드를 추가해줍니다.
		...
		// 상품가격, 상품할인율 순으로 입력했다가 다시 상품가격을 수정하는 경우 이러한 상황에서도 할인 가격을 바로 볼 수 있도록 하는 메서드와 코드
