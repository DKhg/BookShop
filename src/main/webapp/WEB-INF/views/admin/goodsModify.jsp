                    	...
                    	<form action="/admin/goodsModify" method="post" id="modifyForm">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content bit">
                    				<input name="bookIntro" value="${goodsInfo.bookIntro}">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content bct">
                    				<input name="bookContents" value="${goodsInfo.bookContents}">
	...
	$(document).ready(function(){
		...
		$.getJSON("/getAttachList", {bookId : bookId}, function(arr){
			...
			if(arr.length === 0){
				...
				str += "<img src='/resources/img/이미지없음.png'>";
				str += "</div>";
...
<!-- 새로 작성할 코드는 렌더링 될 때 실행될 코드와 구분하기 위해서 기존의 <script> 태그 아래에 새로운 <script>를 추가하여 작업	 -->
<script>
/* 카테고리 */
let cateList = JSON.parse('${cateList}');
